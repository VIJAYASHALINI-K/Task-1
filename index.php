        ...
        $(document).ready(function(){
            $("#password").on('blur',function(){
                ...
                if(password.match(passwordPattern) && (password.length>=8)){               
                    ...
                    $('#passwordValidation').text('Please enter valid email address').css('color','red');
                }
            });
        });
...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        */
        ...
        if($emailAddressPresentInUser){
            echo '<span style=font-size:20px;>'."You are already registerd. Try to login<br>".'</span>';
        }
        else{
